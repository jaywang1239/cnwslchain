  ...
  return (
    <footer className="bg-brand-ink text-white">
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-3 lg:px-8">
        <div>
          <BrandLogo locale={locale} tone="onInk" />
          <p className="mt-3 text-sm text-white/80">{copy.legalName}</p>
          <p className="mt-4 text-sm text-white/70">{copy.footer.blurb}</p>
          {overseas ? (
            <div className="mt-5">
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/80">
            ...
            <li>
              ...
              <a
                ...
                className="break-all text-brand-accent hover:text-white"
              >
                {siteConfig.email}
              </a>
            </li>
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between md:col-span-2 lg:col-span-1">
          <div className="min-w-0 flex-1">
            ...
            <Link
              ...
              className="mt-4 inline-block text-sm font-medium text-brand-accent hover:text-white"
            >
              {copy.contactCta}
            </Link>
          </div>
