...
const INTRO_PHRASES: Record<NonZh, Array<[RegExp | string, string]>> = {
  ...
  es: [
    ...
    [/内宽/g, "ancho interior"],
    [/覆盖/g, "cubre"],
    [/可选弯曲半径/g, "Radios de curvatura disponibles"],
    [/威仕龙/g, "CNWSL"],
    [/拖链/g, "portacables"],
  ],
  it: [
...
const QR_ALT: Record<Locale, string> = {
  ...
  vi: "Mã QR mini chương trình WeChat chọn mẫu CNWSL",
...
const IMAGE_ALT_PARTS: Record<string, Record<NonZh, string>> = {
  ...
  纯白底洁净室电缆拖链: {
    en: "cleanroom cable carrier on white background",
    ...
    ru: "кабельная цепь для чистых помещений на белом фоне",
  },
  纯白底电缆拖链: {
    en: "cable carrier on white background",
    vi: "xích dẫn cáp nền trắng",
    es: "portacables sobre fondo blanco",
    it: "catena portacavi su fondo bianco",
    ru: "кабельная цепь на белом фоне",
  },
  无尘拖链: {
    en: "cleanroom cable carrier",
    vi: "xích dẫn cáp phòng sạch",
  ...
  微型拖链: {
    en: "micro cable carrier",
    vi: "xích dẫn cáp cỡ nhỏ",
    es: "portacables micro",
    it: "catena portacavi micro",
    ru: "микрокабельная цепь",
  },
  中型拖链: {
    en: "medium cable carrier",
    vi: "xích dẫn cáp cỡ trung",
    es: "portacables mediano",
    it: "catena portacavi media",
    ru: "кабельная цепь среднего размера",
  },
  承重拖链: {
    en: "heavy-duty cable carrier",
    vi: "xích dẫn cáp chịu tải",
    es: "portacables de gran carga",
    it: "catena portacavi per carichi pesanti",
    ru: "усиленная кабельная цепь",
  },
  静音拖链: {
    en: "silent cable carrier",
    vi: "xích dẫn cáp chạy êm",
    es: "portacables silencioso",
    it: "catena portacavi silenziosa",
    ru: "бесшумная кабельная цепь",
  },
  便携式拖链: {
    en: "portable cable carrier",
    vi: "xích dẫn cáp di động",
    es: "portacables portátil",
    it: "catena portacavi portatile",
    ru: "портативная кабельная цепь",
  },
  系列: {
    en: "series",
    vi: "series",
